<template>
  <div class="feedback-list">
    <div class="title">
      ...
      <el-button-group>
        ...
        >
          ...
          Selected [{{ idsToDelete.length }}] , please confirm your operation!!!
          <template #footer>
            <el-button type="primary" @click="handleBulkDelete(idsToDelete)">
              Confirm
            </el-button>
            <el-button @click="feedbackBulkDeleteVisible = false">Cancel</el-button>
          </template>
        </el-dialog>
      </el-button-group>
    </div>
    ...
    >
      ...
      Selected [1] , please confirm your operation!!!
      <template #footer>
        <el-button type="primary" @click="handleDelete(feedbackInfo.id)">
          Confirm
        </el-button>
        <el-button @click="feedbackDeleteVisible = false">Cancel</el-button>
      </template>
    </el-dialog>
