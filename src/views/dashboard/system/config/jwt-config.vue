<template>
  <div class="jwt-config">
    <el-col :span="12">
      <div class="info">
        <div class="title">
          <el-row>JWT Configuration</el-row>
        </div>
        <div class="content">
          <el-form
              :model="jwtInfo"
