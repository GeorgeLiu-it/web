<template>
  <div class="article-publish">
      ...
      <div class="left">
        <el-form :inline="true">
          <el-form-item label="Title">
            <el-input v-model="title" placeholder="Please input the title" clearable/>
          </el-form-item>
        </el-form>
      </div>
      <div class="right">
        <el-text>Auto Save</el-text>
        <el-switch v-model="isAutoSaveEnabled"/>
        <el-button type="danger" icon="Delete" @click="title='';text=''">Clear content</el-button>
        <el-button type="success" icon="Plus" @click="layoutStore.state.articleCreateVisible=true">Publish</el-button>
        <el-dialog
    ...
    <MdEditor v-model="text" language="en-US" @onUploadImg="onUploadImg" @onSave="onSave" @onChange="onChange"/>
  </div>
</template>
