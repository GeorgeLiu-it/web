<template>
  <div class="comment-list">
      ...
      <el-button-group>
        ...
        >
          ...
          <template #footer>
            ...
            <el-button @click="commentBulkDeleteVisible = false">Cancel</el-button>
          </template>
        </el-dialog>
      </el-button-group>
    </div>
    ...
    <div class="comment-list-request">
      <el-form :inline="true" :model="commentListRequest">
        <el-form-item label="Article id">
          <el-input v-model="commentListRequest.article_id" placeholder="Please input article id" clearable/>
        </el-form-item>
        <el-form-item label="uuid">
          <el-input v-model="commentListRequest.user_uuid" placeholder="Please input user uuid" clearable/>
        </el-form-item>
        <el-form-item label="Content">
          <el-input v-model="commentListRequest.content" placeholder="Please input comments" clearable/>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="Search" @click="getCommentTableData">Search</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    >
      ...
      <el-table-column label="Article id" width="200">
    ...
    >
      ...
      <template #footer>
        ...
        <el-button @click="commentDeleteVisible = false">Cancel</el-button>
      </template>
    </el-dialog>
