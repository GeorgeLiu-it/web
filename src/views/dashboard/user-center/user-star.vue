<template>
  <div class="user-star">
    <el-row class="title">Star</el-row>
    ...
    >
      ...
      <el-table-column prop="_source.category" label="Category" width="80"/>
      ...
      <el-table-column prop="_source.created_at" label="Publish time" width="102"/>
