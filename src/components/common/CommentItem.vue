      ...
      <div class="item-card">
        ...
        <div class="footer">
          <div class="button-group">
            <el-button v-if="replyFlag===item.id" type="primary" @click="submitReply(item);content=''">Confirm</el-button>
            <el-button v-if="replyFlag===item.id" @click="content='';replyFlag=0">Cancel</el-button>
            <el-button v-if="!(replyFlag===item.id)" type="primary" @click="replyFlag=item.id">Reply</el-button>
        ...
        <div v-if="replyFlag===item.id" class="reply">
          <el-input class="comment-input" v-model="content" :autosize="{ minRows: 4, maxRows: 8 }" type="textarea"
                    placeholder="Please input your reply" maxlength="320"/>
